...
## 如何接入 Arduino
陆续有开发者问到，如何使用 CodeLab Adapter 将 Arduino 接入到 Scratch 3.0中。
...
CodeLab Adapter 既是消息中心，又是 UI 程序，CodeLab Adapter 可以运行在：
...
CodeLab Adapter 允许以[命令行方式启动（没有 GUI）](/user_guide/FAQ/#_4)。
